...
public class ModBiomes {
    ...
    // 自定义生物群系注册表项的创建
    public static final RegistryKey<Biome> BLOODY_PLAIN = RegistryKey.of(Registry.BIOME_KEY,
            new Identifier(ExampleFabricMod.MOD_ID, "bloody_plain"));
    ...
    public static void registerModBiomes() {
        ...
        // 将自定义生物群系添加到注册表中
        Registry.register(BuiltinRegistries.BIOME, BLOODY_PLAIN.getValue(), ModOverworldBiomes.BLOODY_PLAIN());
